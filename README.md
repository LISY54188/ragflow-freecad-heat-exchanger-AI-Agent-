...
暑假学了一点ansys，最基本的分析流程：
0.导入零件

1.设置材料

1.确定分析类型，静力学，动力学，热力学，进行零件分割

2.网格划分

3.设置约束类型(重力加速度，压力，载荷，热源)，进行仿真计算

4.分析解：变形，应力，传热量

今天做了最简单的就是壳体和封头的压力测试，但是法兰，入流口和管板那里还是不敢动，自己分析的原因是自己目前不知道对于如何把换热器像是做手术一样有机地切开，更别提后面的所谓网格化或者约束了。
应对方法是：

1.需要去真正具体了解载荷传导。

2.约束的力学意义，要求了解组装的结构之间的限位具体如何。

3.还了解了一些关于子模型的内容，例如利用对称性，可以做到对管板进行局部分析，利用物理问题的对称性得出整体数据

此外子模型还有对边界局部进行关键处理分析，网格加密、局部载荷精细计算、应力细节处理和真实连接方法分析等。

希望能够继续深化学习结构，以及更加熟练ansys的使用
